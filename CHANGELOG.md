...
- Added a compact replay-safe grouped delegation result card with child status, summary, attempts, and bounded details; it truthfully renders retained terminal output until the Svelte transport exposes official live agent-tool events.
