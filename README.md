...
| Work Code Mode | Generated source is limited to 32 KiB and each Code Mode execution has a 60s wall-clock limit. Confinement does not reduce the authority of an allowlisted callback. |
