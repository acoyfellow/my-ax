...
assertIncludes(chat, "evaluateTurnStall", "the watchdog uses the shared turn-stall evaluator");
assertIncludes(chat, "pushError(stallMessage(verdict)", "stalled turn surfaces a truthful error");
assertIncludes(chat, "lastTurnFrameAt", "the watchdog tracks the last turn frame time");
assertIncludes(chat, "forgetActiveTurn();\n        applyStatus(\"idle\");", "a surfaced stall unlocks the local composer for retry");
