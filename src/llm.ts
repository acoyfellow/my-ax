...
function anthropicGatewayURL(baseURL: string): string {
  // A gateway may publish sibling OpenAI + Anthropic protocol endpoints. The
  // a gateway may use /openai and /anthropic; a direct Anthropic endpoint
  // can simply be configured as-is.
