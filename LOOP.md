...
- `/Users/owner/cloudflare/.context/TERRALOOP.md`
- `/Users/owner/cloudflare/terrarium/.context/SELF_HEALING_TERRALOOP.md` for question-first experiments, per-round reconciliation, parent verification, self-editing, and independent stop-gate review. The Terrarium drift campaign's specific deliverables and drift score do not apply unless the current My AX finding is about Terrarium drift.
