...
const runtimeBoundaries = new Set([
  "src/agentcast-tools.ts",
  "src/audio-messages.ts",
  "src/bridge.ts",
  "src/browser-tools.ts",
  "src/cm-snippets.ts",
  "src/cmux-observer.ts",
  "src/computer-filesystem.ts",
  "src/conversation-log.ts",
  "src/machinectl-host.ts",
  "src/push.ts",
  "src/terrarium-tools.ts",
  "src/uploads.ts",
  "src/voice-think-agent.ts",
  "src/work-tools.ts",
  "src/index.tsx",
  "src/agent-stub.ts",
  "src/agent.ts",
  ...
  "src/pantry-sync.ts",
  "src/recurring-job-run.ts",
  "src/run-receipts.ts",
  "src/saved-recipes.ts",
